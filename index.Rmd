...
```{r, include-url1, out.width='100%', fig.cap="Embed Yihui's homepage as an iframe or screenshot.", dev='png', cache=TRUE, screenshot.opts=list(vwidth=992)}
knitr::include_url("https://github.com/dubsnipe/clases-innovacion-2021/blob/main/01/01.html")
```
