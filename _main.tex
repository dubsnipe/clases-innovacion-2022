...
\hypersetup{
  pdftitle={Introducción a la innovación},
  pdfauthor={Emilio Velis},
  hidelinks,
...
\title{Introducción a la innovación}
\author{Emilio Velis}
\date{2021-12-06}
...
For example, we are using the \textbf{bookdown} package (\protect\hyperlink{ref-R-bookdown}{Xie 2021}) (check out the last code chunk in index.Rmd to see how this citation key was added) in this sample book, which was built on top of R Markdown and \textbf{knitr} (\protect\hyperlink{ref-xie2015}{Xie 2015}) (this citation was added manually in an external file book.bib).
